...
def process_chunks(chunks_dir, db_path, output_dir, process_script, delay=10, limit=None):
    """
    Process chunks sequentially with a delay between them
...
def main():
    """Main function"""
    parser = argparse.ArgumentParser(description='Process chunks sequentially with a delay')
    ...
    process_chunks(args.chunks_dir, args.db_path, args.output_dir, 
