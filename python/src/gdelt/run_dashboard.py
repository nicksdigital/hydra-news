#!/usr/bin/env python3
"""
Run the GDELT News Analysis Dashboard

This script runs the GDELT News Analysis Dashboard server.
"""
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='Run GDELT News Analysis Dashboard')
...
def main():
    ...
    server_script = os.path.join(script_dir, 'visualizer', 'server.py')
