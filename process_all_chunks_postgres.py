#!/usr/bin/env python3
"""
Process all chunks with a delay between them using PostgreSQL
"""
...
def main():
    """Main function"""
    parser = argparse.ArgumentParser(description='Process all chunks with a delay using PostgreSQL')
    ...
    parser.add_argument('--process-script', type=str, 
                        default='python/src/gdelt/analyzer/process_chunk_postgres.py',
