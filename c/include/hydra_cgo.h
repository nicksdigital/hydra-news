 ...
 * This header provides simplified C functions that are easier to call from Go
 */
 ...
 * @param country_code Country code string (C-string)
 * @param region_code Region code string (C-string)
 ...
 * 
 * @param public_key Buffer to receive the public key (must be at least KYBER_PUBLIC_KEY_BYTES)
 * @param secret_key Buffer to receive the secret key (must be at least KYBER_SECRET_KEY_BYTES)
 * @return 0 on success, error code otherwise
 */
 ...
 * 
 * @param public_key Buffer to receive the public key (must be at least FALCON_PUBLIC_KEY_BYTES)
 * @param secret_key Buffer to receive the secret key (must be at least FALCON_SECRET_KEY_BYTES)
 * @return 0 on success, error code otherwise
 */
 ...
 * @param signature Buffer to receive the signature (must be at least FALCON_SIGNATURE_MAX_BYTES)
 ...
 * @param ciphertext Buffer to receive the ciphertext (must be at least KYBER_CIPHERTEXT_BYTES)
 * @return 0 on success, error code otherwise
 */
